...
namespace TournamentsRecord.DAL.DataAccess
{
    public class TournamentsRecordContext: DbContext
    {
        public TournamentsRecordContext(DbContextOptions options) : base(options) { }
